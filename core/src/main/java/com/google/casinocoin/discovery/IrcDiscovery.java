...
package com.google.casinocoin.discovery;

import com.google.casinocoin.core.AddressFormatException;
import com.google.casinocoin.core.Base58;
...
public class IrcDiscovery implements PeerDiscovery {
    ...
    public InetSocketAddress[] getPeers(long timeoutValue, TimeUnit timeoutUnit) throws PeerDiscoveryException {
        ...
        try {
            ...
            // casinocoinj but not match the standard nick format, so full peers don't try and connect to us.

...
package com.google.casinocoin.utils;
...
/**
 * A wrapper around explicit lock creation that lets you control whether casinocoinj performs cycle detection or not.
 */
public class Locks {

    static {
        // Default policy goes here. If you want to change this, use one of the static methods before
        // instantiating any casinocoinj objects. The policy change will take effect only on new objects

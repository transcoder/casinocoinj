 ...
 * To enable debug logging from the library, run with -Dcasinocoinj.logging=true on your command line.
 */
public class Utils {
    ...
    /**
     * <p>
     * Returns the given value as a plain string denominated in CSC.   
     * The result is unformatted with no trailing zeroes.
     * For instance, an input value of BigInteger.valueOf(150000) nanocoin gives an output string of "0.0015" CSC
     * </p>
     * 
     * @param value The value in nanocoins to convert to a string (denominated in CSC)
    ...
    public static String litecoinValueToPlainString(BigInteger value) {
        ...
        BigDecimal valueInCSC = new BigDecimal(value).divide(new BigDecimal(Utils.COIN));
        return valueInCSC.toPlainString();
    }

 ...
 * the lightweight SPV mode, a {@link com.google.casinocoin.store.BoundedOverheadBlockStore} may be a good choice.</p>
 *
 ...
 * {@link com.google.casinocoin.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
...
public abstract class AbstractBlockChain {
    ...
    private boolean add(Block block, Set<Sha256Hash> filteredTxHashList, List<Transaction> filteredTxn, boolean tryConnecting)
        ...
        try {
            ...
            // article here for more details: http://code.google.com/p/casinocoinj/wiki/SecurityModel
            try {
                block.verifyHeader();

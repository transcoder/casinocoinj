...
package com.google.casinocoin.core;

import com.google.casinocoin.crypto.KeyCrypterScrypt;
import org.casinocoinj.wallet.Protos.Wallet.EncryptionType;
import org.spongycastle.crypto.params.KeyParameter;

import com.google.casinocoin.core.TransactionConfidence.ConfidenceType;
import com.google.casinocoin.core.WalletTransaction.Pool;
import com.google.casinocoin.crypto.KeyCrypter;
import com.google.casinocoin.crypto.KeyCrypterException;
import com.google.casinocoin.store.WalletProtobufSerializer;
import com.google.casinocoin.utils.Locks;
...
import static com.google.casinocoin.core.Utils.litecoinValueToFriendlyString;
 ...
 *
 * <p>To learn more about this class, read <b><a href="http://code.google.com/p/casinocoinj/wiki/WorkingWithTheWallet">
 ...
 * other objects, see the <a href="http://code.google.com/p/casinocoinj/wiki/GettingStarted">Getting started</a> tutorial
 * on the website to learn more about how to set everything up.</p>
 *
 * <p>Wallets can be serialized using either Java serialization - this is not compatible across versions of casinocoinj,
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.casinocoin.core.Wallet.AutosaveEventListener)}
...
public class Wallet implements Serializable, BlockChainListener {
    ...
    public void receivePending(Transaction tx, List<Transaction> dependencies) throws VerificationException {
        ...
        try {
            ...
            if (log.isInfoEnabled()) {
                log.info(String.format("Received a pending transaction %s that spends %s CSC from our own wallet," +
                        " and sends us %s CSC", tx.getHashAsString(), Utils.litecoinValueToFriendlyString(valueSentFromMe),
    ...
    private void receive(Transaction tx, StoredBlock block, BlockChain.NewBlockType blockType, boolean reorg) throws VerificationException {
        ...
        if (!reorg) {
            log.info("Received tx {} for {} CSC: {}", new Object[]{sideChain ? "on a side chain" : "",
    ...
    public static class SendRequest {
         ...
         * attacks expensive. Some transactions require a fee due to their structure - currently casinocoinj does not
     ...
     * followed by {@link Wallet#completeTx(com.google.casinocoin.core.Wallet.SendRequest)} and returning the requests
     ...
     * {@link Wallet#completeTx(com.google.casinocoin.core.Wallet.SendRequest)} to make it valid.
     *
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.casinocoin.core.Wallet.AutosaveEventListener)}
    ...
    public String toString(boolean includePrivateKeys, AbstractBlockChain chain) {
        ...
        try {
            ...
            builder.append(String.format("Wallet containing %s CSC in:%n", litecoinValueToFriendlyString(getBalance())));
     ...
     * {@link com.google.casinocoin.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.google.casinocoin.crypto.KeyCrypter,
     ...
     * {@link com.google.casinocoin.crypto.KeyCrypterScrypt}.
     *
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(com.google.casinocoin.crypto.KeyCrypter,

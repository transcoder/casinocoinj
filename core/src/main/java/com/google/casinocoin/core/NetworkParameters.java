...
import static com.google.casinocoin.core.Utils.COIN;
...
public class NetworkParameters implements Serializable {
    ...
    /** Unit test network. */
    static final String ID_UNITTESTNET = "com.google.casinocoin.unittest";
    ...
    private NetworkParameters(int type) {
        ...
        if (type == 0 || type == 100) {
            ...
            packetMagic = 0xfac3b6da; // pchMessageStart
            genesisBlock.setDifficultyTarget(0x1e0ffff0L);
            genesisBlock.setTime(1372838150L);  // nTime
            genesisBlock.setNonce(16762L);  // nNonce
            genesisBlock.setMerkleRoot(new Sha256Hash("73d304deca65f150913c0f87305dec7aa3913919889e483aa04bda87133023e6"));
            id = ID_PRODNET;
            subsidyDecreaseBlockCount = 3153600;
            allowEmptyPeerChains = false;
            spendableCoinbaseDepth = 100;
            String genesisHash = genesisBlock.getHashAsString();
            checkState(genesisHash.equals("4f46c9af6d88a14114b7dc53a37d81ba4064cda5ae2ede1213ca28fea9b86e9c"),
                    genesisHash);
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            //
            //   "NY Times 2/July/2013 What the N.S.A. Knows About You"
            byte[] bytes = Hex.decode
                    ("1d00ffff4e592054696d657320322f4a756c792f32303133205768617420746865204e2e532e412e204b6e6f77732041626f757420596f75");
     ...
     */
    public static final BigInteger MAX_MONEY = new BigInteger("336000000", 10).multiply(COIN);

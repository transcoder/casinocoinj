...
import com.google.casinocoin.store.BlockStoreException;
...
public class Peer {
  ...
  private void processMessage(MessageEvent e, Message m) throws IOException, VerificationException, ProtocolException {
     ...
     * Once the pong is received the value returned by {@link com.google.casinocoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.casinocoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.casinocoin.core.Peer#ping()} has never

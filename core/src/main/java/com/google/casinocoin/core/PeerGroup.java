...
import com.google.casinocoin.core.Peer.PeerHandler;
import com.google.casinocoin.discovery.PeerDiscovery;
import com.google.casinocoin.discovery.PeerDiscoveryException;
...
public class PeerGroup extends AbstractIdleService {
     ...
     * peers. By using this with {@link com.google.casinocoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.casinocoin.core.PeerGroup#getMaxConnections()} returns is used.
     * @return
     */
    ...
    /**
     * See {@link com.google.casinocoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.casinocoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.casinocoin.core.Peer#ping()}.
     */

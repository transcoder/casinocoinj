...
public class ECKey implements Serializable {
     ...
     * usually encoded using DER format, so you want {@link com.google.casinocoin.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Litecoin protocol, they are
     * usually encoded using DER format, so you want {@link com.google.casinocoin.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * the {@link com.google.casinocoin.core.DumpedPrivateKey#toString()} method to get the string.
     *

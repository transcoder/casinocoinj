...
import com.google.casinocoin.core.Transaction.SigHash;
...
import com.google.casinocoin.store.BlockStore;
import com.google.casinocoin.store.MemoryBlockStore;
...
import static com.google.casinocoin.core.TestUtils.*;
import static com.google.casinocoin.core.TestUtils.createFakeBlock;
import static com.google.casinocoin.core.TestUtils.createFakeTx;
import static com.google.casinocoin.core.Utils.litecoinValueToFriendlyString;
import static com.google.casinocoin.core.Utils.toNanoCoins;
...
public class WalletTest {
    ...
    public void spendToSameWallet() throws Exception {
        ...
        assertEquals(BigInteger.ZERO, wallet.getBalance());
        sendMoneyToWallet(outbound1, AbstractBlockChain.NewBlockType.BEST_CHAIN);
        // We should have a balance of 1 CSC after the block is received.
        assertEquals(coin1, wallet.getBalance());
    }
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("casinocoinj-unit-test", null);
